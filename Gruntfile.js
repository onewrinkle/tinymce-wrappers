...
module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    concat: {
      license: {
        ...
        files: {
          'dist/separator/plugin.js': [
            'src/text/license-header.js',
            scratchPluginMinPath
          ],
          'dist/separator/plugin.min.js': [
            'src/text/license-header.js',
            scratchPluginMinPath
          ]
        }
    ...
    copy: {
      css: {
        files: [
          ...
          { src: ['changelog.txt'], dest: 'dist/separator', expand: true }
        ]
      }
    },
  ...
  grunt.registerTask('version', 'Creates a version file', function () {
    grunt.file.write('dist/separator/version.txt', BUILD_VERSION);
  });
